...
interface ConnectorInterface extends Component {
    ...
    previewObject?(engine: EngineInterface, connector: ConnectorInterface, options: PreviewObjectOptions): Promise<PreviewObjectResult>; // Preview an object for a specified connection.
