...
interface ConnectorInterface extends Component {
    ...
    previewObject?(engineAPI: EngineAPI, connector: ConnectorInterface, options: PreviewObjectOptions): Promise<PreviewObjectResult>; // Preview an object for a specified connection.
